...
//			dest.setWordWrap(pPr.getWordWrap());
    ...
    public static Property createPropertyFromCssName(String name, CSSValue value) {
        ...
        Property p = null;
        try {
            p = createRunPropertyFromCssName(name, value);
            if (p == null) {
                p = createParagraphPropertyFromCssName(name, value);
            }
    ...
    public static Property createRunPropertyFromCssName(String name, CSSValue value) {
        // Run properties
        ...
        }  else if (name.equals(HighlightColor.CSS_NAME)) {
            if (!value.getCssText().equals("transparent")){
    ...
    public static Property createParagraphPropertyFromCssName(String name, CSSValue value) {
        ...
        try {
            ...
            } else if (name.equals(PShading.CSS_NAME)) {
                if (!value.getCssText().equals("transparent")){
